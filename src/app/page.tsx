...
import { ArrowRight, Music, ArrowDown, Sparkles } from "lucide-react";
          ...
          <span className="font-hand text-3xl md:text-4xl text-accent mb-4 block transform -rotate-2">
            Welcome to the Land of Gods
                      ...
                      <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold font-serif tracking-tight mb-6 drop-shadow-lg">
                          Discover <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-white/80">Uttarakhand</span>
                      </h1>
                      ...
                      <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                          <Button onClick={() => router.push("/explore")} size="lg" className="cursor-pointer rounded-full text-lg px-8 py-6 bg-secondary hover:bg-secondary/90 text-white border-none shadow-lg shadow-secondary/20">
                              Start the Journey
                          </Button>

                          <Button onClick={() => router.push("/support")} size="lg" variant="outline" className="cursor-pointer rounded-full text-lg px-8 py-6 bg-white/10 hover:bg-white/20 text-white border-white/30 backdrop-blur-sm">
                              Support us
                          </Button>
                      </div>
                  </motion.div>
          ...
          <Section centered className="bg-white relative">
              ...
              >
                  ...
                  <p className="text-lg md:text-xl text-muted-foreground leading-relaxed mb-8">
                      Uttarakhand is not just a place; it&#39;s a feeling. It&#39;s the echo of temple bells in the morning mist,
                      the warmth of a wood-fired stove in a village home, and the rhythm of folk songs that have been
                      sung for centuries. Here, we invite you to explore the unseen and unheard stories of this divine land.
                  </p>
              </motion.div>
          </Section>
                  ...
                  {[
                      ...
                      >
                          <Link href={item.link} className="block h-full">
                                  <Card className="h-full border-none shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 overflow-hidden group bg-gray-50 cursor-pointer">
                                      ...
                                      <CardContent className="p-8 flex flex-col h-full">
                                          ...
                                          <div className="bg-white p-4 rounded-lg border border-border/50 group-hover:bg-secondary/5 transition-colors shadow-sm">
                                              <span className="text-xs uppercase tracking-wider text-muted-foreground block mb-1">Say Hello</span>
              ...
              <div className="relative">
                  <div className="flex flex-col md:flex-row gap-12 items-center">
                      ...
                      >
                          ...
                          <h3 className="text-3xl md:text-4xl lg:text-5xl font-serif font-bold">The Legend of Nanda Devi</h3>
                          <p className="text-muted-foreground text-lg leading-relaxed">
                              Revered as the patron goddess of the Garhwal and Kumaon Himalayas, Nanda Devi is not just a peak but a divine entity.
                              Legend has it that she was a princess who escaped a roguish prince to merge with the mountains, becoming their eternal guardian.
                              Every 12 years, the Nanda Devi Raj Jat Yatra celebrates her journey back to her husband&#39;s home in Kailash.
                          </p>
                          <Link href="/god/nanda-devi">
                              <Button variant="link" className="text-secondary p-0 text-lg h-auto font-serif italic hover:underline">
                      ...
                      >
                          <Link href="/god/nanda-devi">
                              <div className="aspect-[4/3] rounded-2xl overflow-hidden bg-gray-100 shadow-2xl rotate-2 hover:rotate-0 transition-transform duration-500 group cursor-pointer">
                                  <Image
                                      src={nandaImg}
                                      alt="Nanda Devi Peak"
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:auto-rows-[300px]">
                  ...
                  >
                      <Link href="/explore/temples" className="block w-full h-full">
                              <Image src={templeImg} alt="Spiritual Heritage" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
                              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent p-8 flex flex-col justify-end">
                                  <span className="text-secondary font-medium tracking-wider uppercase text-xs mb-2">Spiritual</span>
                                  <h3 className="text-3xl font-serif font-bold text-white mb-2">Abodes of the Divine</h3>
                                  <p className="text-white/80 max-w-lg line-clamp-2">From the Char Dham to hidden village temples, spirituality is woven into every stone.</p>
                              </div>
                      </Link>
                  </motion.div>
                  ...
                  >
                      <Link href="/explore" className="block w-full h-full">
                              <Image src={aipanTexture} alt="Aipan Art" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
                              <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center p-6 text-center backdrop-blur-sm">
                                  <div>
                                      ...
                                      <Button variant="outline" className="text-white border-white hover:bg-white hover:text-black">Learn Technique</Button>
                                  </div>
                              </div>
                      </Link>
                  </motion.div>
                  ...
                  >
                      <Link href="/explore/recipes" className="block w-full h-full">
                              <Image src={foodImg.src} alt="Pahadi Cuisine" fill className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
                  ...
                  >
                      <Link href="/explore" className="block w-full h-full">
                              <Image src={danceImg} alt="Folk Dance" className="w-full h-full object-cover object-top transition-transform duration-700 group-hover:scale-105" />
                              <div className="absolute inset-0 bg-gradient-to-r from-black/70 via-black/30 to-transparent p-8 flex flex-col justify-center">
                                  <div className="max-w-xl">
                                      <span className="text-accent font-medium tracking-wider uppercase text-xs mb-2">Celebration</span>
                                      <h3 className="text-3xl font-serif font-bold text-white mb-4">Rhythms of the Mountains</h3>
                                      <p className="text-white/80 mb-6">
                                          When the Dhol-Damau plays, the feet don&#39;t stop. Explore the vibrant folk dances like Choliya, Jhora, and Chancheri.
                                      </p>
