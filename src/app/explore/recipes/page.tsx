      ...
      <section className="pt-32 pb-12 px-6 bg-white border-b border-border">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl">
             Simple ingredients, rustic methods, and divine taste. Explore the authentic recipes from the kitchens of Uttarakhand.
          </p>
        </div>
      </section>
               ...
               <Link href={recipe.link} className="group block h-full">
                     ...
                     <Card className="h-full overflow-hidden border-none shadow-md hover:shadow-xl transition-all duration-300">
                        <div className="relative h-64 overflow-hidden">
                           <Image  src={recipe.image} alt={recipe.title} className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" fill/>
                        ...
                        <CardContent className="p-6">
                           ...
                           <Button variant="outline" className="w-full group-hover:bg-secondary group-hover:text-white group-hover:border-secondary transition-colors">
