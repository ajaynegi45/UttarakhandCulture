      ...
      <div className="relative h-[60vh] w-full overflow-hidden">
         ...
         <div className="absolute bottom-0 left-0 right-0 p-8 md:p-20 text-white z-20">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
               <span className="bg-secondary px-3 py-1 rounded-full text-xs font-bold uppercase tracking-widest mb-4 inline-block">Main Course</span>
            ...
            <div className="md:col-span-2 space-y-8">
               <div>
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                     Bhatt ki Churkani is a signature dish of Kumaon, made from black soybeans (Bhatt). It is traditionally cooked in an iron kadhai, which enriches the dish with iron and gives it a characteristic dark green/black color. It is best enjoyed with steamed rice and a dollop of ghee.
                  </p>
               </div>
               ...
               <div>
                  ...
                  <ol className="space-y-6 text-muted-foreground list-decimal pl-5">
                     <li className="pl-2">Heat oil in an iron kadhai. Add the black soybeans (Bhatt) and fry them until they start crackling. Remove and keep aside.</li>
                     <li className="pl-2">In the same oil, add cumin seeds and chopped onion. Sauté until golden brown. Add ginger and garlic paste.</li>
                     <li className="pl-2">Add wheat flour and roast it with the onion mixture until it turns aromatic and slightly brown.</li>
                     <li className="pl-2">Add turmeric, coriander powder, and chili powder. Mix well.</li>
                     <li className="pl-2">Add the fried soybeans back into the kadhai. Pour in 3-4 cups of hot water slowly while stirring to avoid lumps.</li>
                     <li className="pl-2">Let it simmer on low heat for 20-30 minutes until the gravy thickens and the beans are soft. The color will darken due to the iron vessel.</li>
            ...
            <div className="md:col-span-1">
               <div className="bg-muted/30 p-6 rounded-2xl sticky top-24">
                  ...
                  <p className="text-sm text-muted-foreground italic mb-6">
                     "Always use hot water to make the gravy. Cold water can harden the beans. Cooking in an iron vessel is non-negotiable for the authentic taste!"
                  </p>
                  <Link href="/recipes">
