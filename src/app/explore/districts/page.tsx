...
export default function DistrictExplorer() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-32 pb-12 px-6 bg-gradient-to-b from-emerald-50/50 to-transparent relative overflow-hidden">
        {/* Background Texture */}
        <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/light-paper-fibers.png')] opacity-100" />
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-8">
              Uttarakhand is a tapestry of 13 distinct districts, each with its own dialect, deity, and destiny.
      ...
      <Section centered className="-mt-12">
        <div className="bg-white rounded-3xl p-2 md:p-3 shadow-2xl border border-border/50 relative overflow-hidden">
          ...
          >
            {/* Text label */}
            <span className="text-xs sm:text-sm mb-2 font-hand text-secondary font-semibold text-center whitespace-nowrap animate-pulse ml-16 sm:ml-13 mb-0 ">
              Tap a district
            </span>
